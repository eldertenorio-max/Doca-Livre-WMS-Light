...
-- Total na planilha: 79 códigos distintos (confira no gerador scripts/gen-upsert-todos-produtos-armazem-88.mjs).
--
...
insert into _stg_armazem88 (codigo_interno, descricao, unidade) values
  ...
  ('01.03.0019', 'ROSCA LISA (PAO DE LEITE) - CX 10 KG -2 UN DE 5 KG', 'PT'),
  ...
  ('01.04.0064', 'MASSA CONGELADA DE BISCOITO PALITO 3 QUEIJOS 45G - 4KG CX', 'PT'),
  ...
  ('02.03.1018', 'CROISSANT TRADICIONAL DE MASSA FOLHADA PREFERMENTADO CONGELADO 70G - 1 PCT DE 3,50KG', 'CX'),
  ...
  ('01.06.0027', 'PAO DE 3 CHOCOLATES - 10 UN - 3KG', 'CX'),
  ('01.06.0030', 'MINI BAGUETE RUSTICA TRADICIONAL - CX 5KG - 2 UN DE 2,5KG', 'CX'),
  ('01.10.0015', 'CIABATTA COM GRÃOSL LEVIASSA- PT 0,220 KG- CX 2,64 KG- 12 UN', 'CX'),
...
delete from public."Todos os Produtos" t
where trim(both from t.codigo_interno) = any (ARRAY['01.04.0019', '01.04.0020', '01.04.0021', '01.04.0022', '01.02.0009', '01.04.0006', '01.04.0001', '01.04.0002', '01.09.0011', '02.03.0041', '02.02.0050', '02.04.0002', '01.04.0007', '01.10.0005']::text[]);
